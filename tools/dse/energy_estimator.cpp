...
int main() {
    ...
    tsmc5nmData.energyMap[EventType::ALU_ADD][static_cast<uint8_t>(32)] = PerBitEnergy{ 1.2e-15 };
    ...
    tsmc5nmData.energyMap[EventType::ALU_MUL][static_cast<uint8_t>(8)] = PerBitEnergy{ 0.8e-15 };
    energyDb.addTechnologyData(tsmc5nmData);

    // Energy data for Intel 18A
    TechnologyEnergyData intel18aData{ Technology::INTEL_18A };
    intel18aData.energyMap[EventType::ALU_ADD][static_cast<uint8_t>(32)] = PerBitEnergy{ 1.0e-15 };
    ...
    intel18aData.energyMap[EventType::ALU_MUL][static_cast<uint8_t>(8)] = PerBitEnergy{ 0.7e-15 };
